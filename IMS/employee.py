...
class employeeclass:
    def __init__(self,root):
        ...
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15), bg="white").place(x=420,y=190)
        ...
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15), bg="white").place(x=530,y=270)
    ...
    def add(self):
        ...
        try:
            if self.var_empid.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","this Employee ID already assigned, try diffirent",parent=self.root)
                else:
